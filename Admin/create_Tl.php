...
<body>
    <h3 style=" margin-top:2rem;margin-bottom:1rem;text-decoration:underline;">Select new Team Leader</h3>
    <div class="row " style="height:80vh; ">
        <div class="col-md-6 m-auto" style="background-color:whitesmoke;border:1px solid grey; height:100%; border-radius:8px; ">
            <form action="" method="post">
                ...
                <input type="submit" class="btn btn-warning" name="Select_Tl" value="Select">
