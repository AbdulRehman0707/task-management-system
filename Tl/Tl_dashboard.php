...
<div class="row">
        ...
        <table class="table">
          <tr>
                <td style="text-align:center;">
                    <a href="Tl_dashboard.php" class=" "type="button" id="logout_link">Team Leader</a>
                </td>
            </tr>
            <tr>
                <td style="text-align:center;">
                    <a href="Tl_dashboard.php" type="button" id="logout_link">Dashboard</a>
                </td>
            </tr>
            <tr>
                <td style="text-align:center;">
    ...
    <div class="" id="header">
       <div class="" style="text-align:right;margin-top:1.5rem;margin-right:3rem;">
        <b>Email:</b> <?php echo $_SESSION['temail']; ?>
    </div>
</div><hr>
